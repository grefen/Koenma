...
namespace {
  ...
  Score evaluate(const Position& pos, Pawns::Entry* e) {
    ...
    e->pawnAttacks[Us] = shift_bb(ourPawns, Right) | shift_bb(ourPawns, Left);
    ...
    while ((s = *pl++) != SQ_NONE)
    {
        ...
        else
        {
            ...
            backward = (b | shift_bb(b, Up)) & theirPawns;
        }
    ...
    b = shift_bb(ourPawns, Right) & shift_bb(ourPawns, Left) & CenterBindMask;
