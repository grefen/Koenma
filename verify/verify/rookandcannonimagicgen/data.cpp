...
void init_magics(Bitboard table[], Bitboard* attacks[], uint96_t magics[],
...
//下面程序在SQ_A3和SQ_G3没有找到相应的imagic
#if 1
void init_magics(Bitboard table[], Bitboard* attacks[], uint96_t magics[], Bitboard masks[], unsigned shifts[], Square deltas[], Fn index) {
    ...
    //                printf("i %d, size %d\n",maxtime,size);
				//}
				magics[s] = rk.magic_bitboard(booster);;//random_bitboard();
